...
espera = game_get_speed(gamespeed_fps);
timer = 0;
...
drop = function()
{
	...
	else
	{
		...
		if (_chance > 0)
		{
			var _powerup = instance_create_layer(x, y, "power_up", choose(obj_powerup, obj_vidaup, obj_escudoup));
			_powerup.x += 2;
			_powerup.y -= 10;
		}
...
state_machine = function()
{
	switch(estado)
	{
		...
		case "atirando":
			...
			var _tiro = instance_create_layer(x, y, "tiro", obj_tiro_mob1);
